...
@section('sidebar')
	...
	<div class="pull-right" style="margin: 0 20px 0 0;">		
		<a href='#'><button type="submit" class="btn btn-primary btn-sm">Upload Invoices</button></a>
		<a href='{{URL::route('seller.invoice.add')}}'><button type="submit" class="btn btn-primary btn-sm">Create Invoice</button></a>
	</div>
@stop
@section('content')
<!-- Row Start -->
